...
import './App.css';
import './index.css'; // Ensure your index.css is also linked
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="hero-text">
            <h1>Hello, I'm Muneiwa Sithagu</h1>
            <h2>Aspiring Web Developer & IT Support Technician</h2>
            <p>
...
<section id="projects" className="projects-section">
  ...
  <div className="project-card">
    ...
    <img src="employee.PNG" alt="Employee App Screenshot" className="project-screenshot" />
  ...
  <div className="project-card">
    ...
    <a href="https://github.com/moneiwa/Hotel-App.git" target="_blank" rel="noopener noreferrer">View Project</a>
  </div>
  ...
  <div className="project-card">
    ...
    <img src="recipe.PNG" alt="Recipe App Screenshot" className="project-screenshot" />
